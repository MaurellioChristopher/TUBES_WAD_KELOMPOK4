...
@section('title', 'Admin - Manage Topics')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center gap-2">
            ...
            <span class="font-semibold text-gray-900">Total Topics: {{ $topics->total() }}</span>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            ...
            <div class="flex gap-2 pt-4 border-t border-gray-100">
                ...
                <form action="{{ route('admin.topics.destroy', $topic->id) }}" 
                      method="POST" 
                      class="flex-1"
                      onsubmit="return confirm('Are you sure you want to delete topic {{ $topic->title }}?');">
                    @csrf
                    @method('DELETE')
    ...
    <div class="bg-white shadow-md rounded-lg p-12 text-center">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2">No topics found</h3>
        <p class="text-gray-500 mb-6">Start by creating the first topic</p>
        <a href="{{ route('admin.topics.create') }}" 
